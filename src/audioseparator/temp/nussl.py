...
audio_signal = nussl.AudioSignal(r"C:\Users\ryellenki\~R\practice\mimasa-project\Mimasa\mimasa\data\audios\input.wav", sample_rate=44100)
...
estimates = {
    'vocals': estimates[0],
    'bass+drums+other': audio_signal - estimates[0]
}
